...
<head>
  ...
  <title>My Streaming - Android TV Streaming</title>
...
<body  style="background-image: url('assets/images/bg-pattern.png');background-color: #343b4a; background-size: cover; padding-bottom: 0; min-height: 100px;">
